...
var Router = Backbone.Router.extend({
    ...
    routes: {
        ...
        "questionswhitespaces/:id/edit": "questionsWhiteSpacesEdit",
        "questionswhitespaces/:id/clone": "questionsWhiteSpacesClone",


        "connections/new": "connectionsNew",
        "questionsconnections/:id/edit": "connectionsEdit",
        "questionsconnections/:id/clone": "connectionsClone",
    ...
    questionsWhiteSpacesEdit: function (id) {
      var self = this;
      console.log('main.js');
      self.navbar();

      templateLoader.load(["QuestionsWhiteSpacesEdit"],
          function () {
              var ss = new Question({
                  id: id
              });
              ss.fetch(function () {
                  var v = new QuestionsWhiteSpacesEdit({
                      model: ss
                  });
                  self.showView(v, $('#content'));
                  self.afterRender(v, $('#content'))
    ...
    questionsWhiteSpacesClone: function (id) {
        var self = this;

        self.navbar();

        templateLoader.load(["QuestionsWhiteSpacesClone"],
            function () {
                var ss = new Question({
                    id: id
                });
                ss.fetch(function () {
                    var v = new QuestionsWhiteSpacesClone({
                        model: ss
                    });
                    self.showView(v, $('#content'));
                    self.afterRender(v, $('#content'))
    ...
    connectionsEdit: function (id) {
      var self = this;
      console.log('main.js');
      self.navbar();

      templateLoader.load(["QuestionsConnectionsEdit"],
          function () {
              var ss = new Question({
                  id: id
              });
              ss.fetch(function () {
                  var v = new QuestionsConnectionsEdit({
                      model: ss
                  });
                  self.showView(v, $('#content'));
                  self.afterRender(v, $('#content'))
    ...
    connectionsClone: function (id) {
        var self = this;

        self.navbar();

        templateLoader.load(["QuestionsConnectionsClone"],
            function () {
                var ss = new Question({
                    id: id
                });
                ss.fetch(function () {
                    var v = new QuestionsConnectionsClone({
                        model: ss
                    });
                    self.showView(v, $('#content'));
                    self.afterRender(v, $('#content'))

window.QuestionsTextEdit = Backbone.View.extend({
    events: {
        ...
        'click .nextStep' : 'drawText'

    },
    drawText: function (e) {
        //Procura os dados da palavra e reproduz
        drawOnNextStep("inputText", "inputText2");
        $("#Rplayer").attr("style", "visibility:hidden; width:100% !important");
        initAudio();
    ...
    addTiming: function (e) {
        ...
        if (!$(e.currentTarget).hasClass('word')) {
            ...
            $(e.target).append(
                '<div class="wordOptions" style="margin-top: 5px">' +

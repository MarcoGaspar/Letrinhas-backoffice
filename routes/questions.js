...
exports.upDate = function (req, res) {
  ...
  console.log('editing question:  '+ user);
  dbTests.list({
                      ...
                      dbQuest.destroy(qustionData._id, qustionData._rev, function (err) {
                          ...
                          if (err) {
                              ...
                              if (JSON.stringify(req.body).indexOf('""') != -1) {
                                  ...
                                  res.send(200, {result: "Pergunta editada com sucesso."});
    ...
    if (JSON.stringify(req.body).indexOf('""') != -1) {
        ...
        switch ($question.type) {
            ...
            case "connections":
                ...
                //console.log($question)
                //Obtem o tipo de pergunta e o tipo de resposta
                $question.content["optionType"] = req.body.optionType;
                $question.content["optionDescrip"] = req.body.optionDescrip;
                $question.content["matchType"] = req.body.matchType;
                $question.content["matchDescrip"] = req.body.matchDescrip;
                console.log("$question")
                console.log($question)
                /*
                $question.content["answerType"] = req.body.answerType;

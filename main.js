...
var category = require('./routes/category'),
    ...
    testSolved = require('./routes/testSolved');
...
app.route('/questions/:id')
    ...
    .delete(auth, tself, perms(2), questions.removeQuestion)
...
app.route('/testSolved/:id')
    .delete(auth, perms(2), testSolved.delete);

//-----------------------------------------------------SCHOOLS

app.route('/schools')
    .post(auth, perms(3), schools.new)
    .get(auth, perms(2), schools.getAll);
...
app.route('/teachers')
    ...
    .get(auth, perms(2), teachers.getAll);

app.route('/teachers/:teacher')//GETS SPECIFIC USER
    .get(auth, tself,perms(2), teachers.getMyDataToEdit)
    .delete(auth, perms(3), teachers.delete)
    .put(auth, perms(2), teachers.editDetails);


app.route('/teachers/editPasswd')
    .post(auth, perms(2), teachers.editPasswd);
